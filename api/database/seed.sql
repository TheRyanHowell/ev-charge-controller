...
-- 'generic' is a battery-less catch-all (e.g. a petrol vehicle) used for 12V
-- maintenance charging only. capacity_kwh = 0 marks "no traction battery";
-- efficiency is 1.0 so no consumer ever divides by zero.
-- Its id sorts before the Maeving ids, so ORDER BY id lists it first.
INSERT OR IGNORE INTO vehicle_models (id, name, capacity_kwh, charger_output_w, charging_efficiency, time_0_100_min, time_0_80_min, time_20_80_min, time_20_100_min, pack_voltage_max_v, pack_cutoff_current_ma, range_min_mi, range_max_mi) VALUES
  ('generic', 'Generic Vehicle', 0, 0, 1.0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0),
