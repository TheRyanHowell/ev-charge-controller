...
-- SQLite requires table recreation to modify foreign key constraints.

-- Charge sessions: cascade from vehicles
...
-- Power readings: cascade from charge_sessions
...
-- SOC snapshots: cascade from charge_sessions
