-- Revert: make namespace nullable again.
...
INSERT INTO plugs_new SELECT id, user_id, name, namespace, mqtt_topic, tls, online, last_seen, last_offline_notified_at, vehicle_id, initialized, created_at FROM plugs;
DROP TABLE plugs;
