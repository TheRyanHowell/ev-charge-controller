-- Make namespace NOT NULL again. Namespace is now generated at plug creation time.
...
INSERT INTO plugs_new SELECT id, user_id, name, namespace, mqtt_topic, tls, online, last_seen, last_offline_notified_at, vehicle_id, initialized, created_at FROM plugs WHERE namespace IS NOT NULL AND namespace != '';
DROP TABLE plugs;
